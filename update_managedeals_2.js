                ...
                <div className="mp-modal-overlay fade-in">
                    <div className="mp-modal-content" style={{maxWidth: '650px', borderRadius: '24px', overflow: 'hidden'}}>
                                ...
                                <div style={{display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', gap: '20px'}}>
                                    <div style={{flex: 1}}>
                                        ...
                                        <div style={{display: 'flex', flexWrap: 'wrap', alignItems: 'center', gap: '12px', fontSize: '0.85rem', color: '#94a3b8', fontWeight: '600', marginBottom: '16px'}}>
                                            {currentProduct.storeName && <span style={{display: 'flex', alignItems: 'center', gap: '4px', background: '#e2e8f0', padding: '4px 10px', borderRadius: '8px', color: '#334155'}}><Store size={14} /> {currentProduct.storeName}</span>}
                        ...
                        <div className="mp-modal-footer" style={{padding: '20px 30px', justifyContent: 'flex-end', gap: '12px'}}>
                            ...
                            <button type="button" className="mp-btn-primary" onClick={() => window.open(\`/deal/\${currentProduct.id}\`, '_blank')} style={{padding: '12px 24px', borderRadius: '12px', fontWeight: '800', background: '#3b82f6', color: 'white', border: 'none', boxShadow: '0 4px 12px rgba(59, 130, 246, 0.3)'}}>View Live Page</button>
                        </div>
                    </div>
                </div>
            )}
...
console.log('Successfully updated ManageDeals.jsx with strict conditional logic.');
